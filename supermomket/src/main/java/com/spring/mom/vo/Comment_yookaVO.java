...
public class Comment_yookaVO {
	...
	public String toString() {
		return "Comment_yookaVO [co_no=" + co_no + ", co_no2=" + co_no2 + ", co_writer=" + co_writer + ", co_content=" + co_content + ", co_date=" + co_date + ", co_date2=" + co_date2 + ", cm_no="
				+ cm_no + "]";
	}
