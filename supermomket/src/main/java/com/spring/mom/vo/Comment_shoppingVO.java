...
public class Comment_shoppingVO {
	private int co_no;
	...
	public String toString() {
		return "Comment_shoppingVO [co_no=" + co_no + ", co_no2=" + co_no2 + ", co_writer=" + co_writer + ", co_content=" + co_content + ", co_date=" + co_date + ", co_date2=" + co_date2 + "]";
	}
