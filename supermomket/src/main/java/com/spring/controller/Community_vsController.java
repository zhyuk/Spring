...
public class Community_vsController {
	...
	public String insertBoard(Community_vsVO vo, MultipartHttpServletRequest request) throws IllegalStateException, IOException {
...
//			System.out.println("Filename2: " + vo.getFilename2());
	...
	public String updateBoard(Community_vsVO vo) {
		System.out.println("/vs_update.do POST 서블릿 실행");
