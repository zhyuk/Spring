					...
					<table class="tableShopping">
						...
						<tbody>
							<c:forEach items="${shoppingList}" var="shoppingList">
								<tr
									onclick="yookaList(${shoppingList.cm_no}, '${searchCondition}', '${searchKeyword}', ${paging.nowPage})"
									style="cursor: pointer; border-bottom: 1px solid #fff;">
									<td class="tdCenter">${shoppingList.cm_no}</td>
									<td class="title" style="text-align: left;">
									<span class="titleflow">${shoppingList.cm_title}</span>
									<span class="titleflow"style="color: red; font-style: bold;">[${shoppingList.cot_cnt}]</span>
									</td>
									...
									<td class="tdCenter">${shoppingList.likecnt}</td>
									<td class="tdCenter">${shoppingList.hatecnt}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
							...
							<div class="detail-box">
								...
								<div class="info12">
									<span class="writer">${shoppingList.cm_writer}</span> <span
										class="comments">조회: ${shoppingList.cm_view}</span> <span
										class="views">추천: ${shoppingList.likecnt}</span> <span class="likes">비추천:
