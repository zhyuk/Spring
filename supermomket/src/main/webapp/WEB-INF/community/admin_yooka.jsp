				...
				<table>
					<tr class="admin_table">
						<th><input type="checkbox" id="all_check" class="pointer"
							name="all_check"></th>
						<th style="width: 120px !important;">번호</th>
					...
					<c:forEach items="${yookaList}" var="yookaList">
						<tr>
							...
							<td><input type="text" name="cm_title"
								value="${yookaList.cm_title}" style="height: 50px;"></td>
							<td><input type="text" name="cm_date"
								value="${yookaList.cm_date}" readonly>
							<td>
								<button style="cursor: pointer;"
									onclick="ShowComment(${yookaList.cm_no})">댓글</button>
								<button style="cursor: pointer;"
									onclick="ContentTog(${yookaList.cm_no})">상세</button>
							</td>
						</tr>
						<tr class="hideContent${yookaList.cm_no} hideContent">
							<td colspan="2">수정하기</td>
							<td colspan="4" style="height: inherit; vertical-align: top;">
								<textarea id="content" class="inputData" name="cm_content"
									placeholder="내용 입력" style="height: 100%;">${yookaList.cm_content}
							</textarea>
							</td>
						</tr>
						<tr class="hideContent${yookaList.cm_no} hideContent">
							...
							<c:forEach items="${yookaListCom}" var="yookaCom">
								<tr>
									...
									<td><button type="button"
											onclick="deleteCom(${yookaCom.cm_no},${yookaCom.co_no})">삭제</button></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
					...
					if (confirm("정말로 삭제하시겠습니까?")) {
						$.ajax({
							...
							success: function (data) {
								...
								con += '<th style="width: 120px;">번호</th>';
